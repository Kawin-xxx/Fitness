...
/* harmony import */ var _modules_tab__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_tab__WEBPACK_IMPORTED_MODULE_3__);
...
/* harmony import */ var _modules_init_swiper__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_4__);
...
var tabOff = function tabOff() {
  //let slides = document.querySelectorAll('.swiper-slide');
  var slides = document.querySelectorAll('.swiper-slide:not(.feedback__item)');
...
var tabOff = function tabOff() {
  var lists = document.querySelectorAll('.subscriptions__list');
  for (var i = 0; i < lists.length; i++) {
    var items = lists[i].querySelectorAll('.subscriptions__item');
    var buttonsHidden = lists[i].querySelectorAll('.subscriptions__button');
